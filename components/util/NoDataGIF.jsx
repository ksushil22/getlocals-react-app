        ...
        <div style={{
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 750 500">
                <g id="freepik--background-complete--inject-6">
                    ...
                    <polygon points="497.83 197.91 385.68 204.85 376.77 60.89 460.05 55.73 490.62 81.38 497.83 197.91"
                             style={{
                                 fill: '#ebebeb'
                             }}></polygon>
                    ...
                    <rect x="99.49" y="322.84" width="34.86" height="9.58"
                          style={{
                              fill: '#dbdbdb'
                          }}></rect>
                </g>
                ...
                <g id="freepik--Shadow--inject-6">
                    <ellipse cx="375" cy="425.29" rx="286.74" ry="31.42"
                             style={{
                                 fill: '#ebebeb'
                             }}></ellipse>
                </g>
                <g id="freepik--Character--inject-6">
                    ...
                    <path d="M238.29,119.17a5,5,0,0,1-2.1,2.51c-1.51.61-2-.76-.48-2A4.88,4.88,0,0,1,238.29,119.17Z"
                          style={{
                              fill: '#262338'
                          }}></path>
                    <path
                    ...
                    <path d="M207.92,151.32a11,11,0,0,1,4.63-.8,10.26,10.26,0,0,1-2.27.64A9.8,9.8,0,0,1,207.92,151.32Z"
                          style={{
                              fill: '#fff'
                          }}></path>
                    <path d="M208.51,131.24a11.16,11.16,0,0,1-2.71,3.85,11.16,11.16,0,0,1,2.71-3.85Z" style={{
                        fill: '#fff'
                    }}></path>
                    <path
                    ...
                    <path d="M212,165.18a10,10,0,0,1-2.07-1.15,10.06,10.06,0,0,1-1.78-1.56,11.16,11.16,0,0,1,3.85,2.71Z"
                          style={{
                              fill: '#fff'
                          }}></path>
                    <path
                ...
                <g id="freepik--Folder--inject-6">
                    ...
                    <g style={{
                        ...
                        <polygon points="576.32 432.05 271.64 432.05 315.69 182.2 620.37 182.2 576.32 432.05"></polygon>
                        <polygon points="419.97 156.32 320.26 156.32 315.69 182.2 422.4 182.2 419.97 156.32"></polygon>
                    </g>
                    ...
                    <path d="M319.06,200a17,17,0,0,1,2.61,3.52,16.8,16.8,0,0,1,1.74,4,19.13,19.13,0,0,1-4.35-7.54Z"
                          style={{
                              fill: '#262338'
                          }}></path>
                    <path
                    ...
                    <path d="M327.66,184.34a19.22,19.22,0,0,1,8.71,0,19.22,19.22,0,0,1-8.71,0Z" style={{
                        fill: '#262338'
                    }}></path>
                    <path
                    ...
                    <circle cx="332.99" cy="325.77" r="12.69" style={{
                        fill: '#262338'
                    }}></circle>
                    <circle cx="433.31" cy="325.77" r="12.69" style={{
                        fill: '#262338'
                    }}></circle>
                    <path
                ...
                <g id="freepik--Fly--inject-6">
                    ...
                    <path d="M634,99.64a33.06,33.06,0,0,0-7,.37,29.2,29.2,0,0,0,3.5,0A31.11,31.11,0,0,0,634,99.64Z"
                          style={{
                              fill: '#262338'
                          }}></path>
                    <path d="M635.93,100.63a7.15,7.15,0,0,0,.62-1.56,7.48,7.48,0,0,0,.26-1.65,7.45,7.45,0,0,0-.88,3.21Z"
                          style={{
                              fill: '#262338'
                          }}></path>
